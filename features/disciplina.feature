Feature: disciplina
  ...
  Scenario: cadastrar disciplina
    ...
    And Preencho nome com "Inglês", ano letivo com "2020" e seleciono a turma de letra "A", ano "8" e ano letivo "2020"
  ...
  Scenario: editar disciplina
    ...
    Given Eu estou na pagina da disciplina de nome "Inglês", ano letivo "2020", de letra "A", ano "8" e ano letivo "2020"
    And Clico em editar a disciplina de nome "Inglês", ano letivo "2020"
    And Preencho nome com "Espanhol", ano letivo com "2021" e seleciono a turma de letra "A", ano "8" e ano letivo "2020"
  ...
  Scenario: cadastrar disciplina com ano letivo menor que o permitido
    ...
    And A turma de letra "A", ano "8" e ano letivo "2020" existe
    Given Eu estou na pagina de cadastro de disciplina
    And Preencho nome com "Inglês", ano letivo com "1999" e seleciono a de letra "A", ano "8" e ano letivo "2020"
    When Clico em cadastrar disciplina
    Then Eu vejo a mensagem de erro "Ano letivo a partir de 2010"
